...
int main(void)
{
    ...
    printf("\n");
    ordinamento_per_data(tratte, numero_dati);
    printf("\n");

    printf("Ordinamento per codice di tratta:");
    printf("\n");
    ordinamento_per_codice_tratta(tratte, numero_dati);
    printf("\n");

    printf("Ordinamento per stazione di partenza:");
    printf("\n");
    ordinamento_per_stazione_di_partenza(tratte, numero_dati);
    printf("\n");

    printf("Ordinamento per stazione di arrivo:");
    printf("\n");
    ordinamento_per_stazione_di_arrivo(tratte, numero_dati);
    printf("\n");
